...
This is a reference grammar for Exwachil, a constructed language (conlang) that appears in \[fictional setting\], along with seven other languages. I constructed this language for my own edification, enjoyment, and artistic expression. My goal for the language was for it to be naturalistic, having all of the complexities and features that natural languages have as they change over time. I have written this grammar to have all of the information in one place, presented in a way that, ideally would be enjoyable and interesting to read for an audience that is interested in conlangs. While Exwachil is still an ongoing project, I am satisfied with the grammar, which is basically stable. Most changes to this document that I would make in the future would be small grammatical changes or additions to the lexicon.
...
This document is divided into X chapters. Chapter A is a brief overview of the language's typology and speakers. Chapter A describes the phonology and the romanization used throughout this document. Chapters A, A, and A cover noun morphology, verb morphology, and adjective morphology, respectively. Chapter A deals with pronouns. Chapter A discusses prepositions and particles. Chapter A describes numerals and classifiers. Chapters A and A respectively deal with noun phrases and verb phrases. Chapter A discusses coordination. Chapter A describes relative clauses. Lastly, chapter A covers the lexicon, and chapter A contains sample texts in Grey Orcish, some original, others translations.
