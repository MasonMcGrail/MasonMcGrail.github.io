...
- [5. Verb morphology](#verb_morphology)
  ...
  - [5.6. Aspect](#verb_aspect)
    - [5.6.1. Perfective aspect](#perfective_aspect)
    - [5.6.2. Imperfective aspect](#imperfective_aspect)
    - [5.6.3. Iterative aspect](#iterative_aspect)
    - [5.6.4. Durative-iterative aspect](#durative_iterative_aspect)
  - [5.7. Voice](#verb_voice)
    - [5.7.1. Active voice](#active_voice)
    - [5.7.2. Mediopassive voice](#mediopassive_voice)
    - [5.7.3. Antipassive voice](#antipassive_voice)
    - [5.7.4. Causative voice](#causative_voice)
    - [5.7.5. Applicative voice](#applicative_voice)
    - [5.7.5. Voice combinations](#voice_combinations)
  - [5.8. Desiderative](#verb_desiderative)
...
When particular morphemes or words are being highlighted, they will be bolded; the following draws attention to the possessive suffix in the above example:
...
????????? nī ??? ???
??- ??- ??? -??      nī     ???      ???
PST-PFV-hunt-1SG.ERG DEF.PL fish yesterday
'I caught the fish yesterday'
...
??????? ??? eng ???
   ??~   ???=??   ??? eng    ???
ANTIP~cut=1SG.ABS ABL DEF.SG knife
...
Eng ??? ??? ???????<b>??</b>
eng    ???  ???  ??- ??? -??     =<b>??</b>
DEF.SG door rock PST-open-3SG.ERG=<b>3SG.ABS</b>
'the stone door that she was opening'

Eng ??? ??<b>??</b>???<b>??</b> ??? eng ??? ???
eng    ???   ??- <b>??</b>~   ??? =<b>??</b>      ??? eng    ???  ???
DEF.SG woman PST-<b>ANTIP</b>~open=<b>3SG.ABS</b> ABL DEF.SG door rock
...
|   | Lemma | 1SG.ERG | 2SG.ERG | 3SG.ERG | CAUS | 3SG.ABS |
| - | ----- | ------- | ------- | ------- | ---- | ------------- |
| **No raising** | tanga | tanga-ra | tango-ong | tanga-s | - | - |
| **Undone: /a/ to /e/** | chin<ins>e</ins> | china-ra | chino-ong | china-s | china-ih | chin<ins>e</ins>=ki |
| **1SG only: /a/ to /o/** | kasnu | kasnu-r<ins>o</ins> | kasno-ong | kasnu-s | kasn-ih | kasnu=ki |
| **-eng: /e/ to /i/** | uneng | unen-ta | un<ins>i</ins>n-ong | unen-su | un<ins>i</ins>n-ih | uneng=ki |
| **-o: /o/ to /u/** | shio | shio-ra | shi<ins>u</ins>t-ong | shios-su | shi<ins>u</ins>ch-ih | shio=ki |
...
??? ??????????? <b>eng</b> ???
???  ??- ??- ??~  ???  -??      <b>eng</b>    ???
then PST-PFV-INTS~close-3SG.ERG <b>DEF.SG</b> door
...
|                         | kangki   | tanga  | uto |
| ----------------------- | -------- | ------ | --- |
| **1st person singular** | kangki**re** | tanga**ra** | uta**ra** |
| **2nd person singular** | kangki**ong** | tang**ōng** | ut**ōng** |
| **3rd person singular** | kangki**s** | tang**s** | uta**s** |
| **1st person plural**   | kangki<b>'ang</b> | tanga<b>'ang</b> | uta<b>'ang</b> |
| **2nd person plural**   | kangki**mi** | tang**mi** | ut**mi** |
| **3rd person plural**   | kangki**pe** | tang**pe** | uta**pe** |

Figure A. _Possessive suffixes with **kangki** 'man, husband', **tanga** 'woman, wife', **uto** 'fire'._
...
???????<b>?? nī ???</b> eng ???
??- ??- ???-<b>??      nī     ???</b>   eng    ???
PST-PFV-cut-<b>3PL.ERG DEF.PL woman</b> DEF.SG rope
'The women cut the rope'
  
???????<b>??</b> eng ???
??- ??- ???-<b>??</b>   eng    ???
PST-PFV-cut-<b>3PL.ERG</b> DEF.SG rope
'The women cut the rope'

?????<b>??</b>?? <b>eng ???</b>
??- ???  -<b>??</b>     =??      <b>eng    ???</b>
PFV-judge-<b>3PL.ERG</b>=3PL.ABS <b>DEF.SG chief</b>
'He will judge them'

?????<b>??</b>??
??- ???  -<b>??</b>     =??
PFV-judge-<b>3PL.ERG</b>=3PL.ABS
'He will judge them'
</pre>
...
### <a name="verb_aspect"></a>5.6. Aspect <a href="#table_of_contents">^</a>

Verbs may be marked for one or more of the following four aspects: perfective, imperfective, iterative, and durative-iterative. Dynamic verbs can be marked for any of these aspects, but stative verbs only get perfective/imperfective marking. Morphologically, these aspects are variously marked by null, prefixes, and reduplication. Their main functions are described below.

#### <a name="perfective_aspect"></a>5.6.1. Perfective aspect <a href="#table_of_contents">^</a>

The perfective aspect is used to refer to events that are conceived of as a bounded whole without interior composition. It is marked by the prefix **l-** before vowels and **i-** before consonants.

<pre>
??<b>??</b>????? wa ???
??- <b>??</b>- ???-??      wa      ???
PST-<b>PFV</b>-buy-1SG.ERG INDF.SG boat
'I bought a boat'
  
??????? wa ???
??- ???-??      wa      ???
PST-buy-1SG.ERG INDF.SG boat
'I was buying a boat'
  
<b>??</b>????? wa ???
<b>??</b>- ???-??      wa      ???
<b>PFV</b>-buy-1SG.ERG INDF.SG boat
'I will buy a boat'
  
????? wa ???
???-??      wa      ???
buy-1SG.ERG INDF.SG boat
'I am buying a boat'
</pre>

With stative verbs and verbal adjectives, this aspect marks entry into the state denoted by the verb.

<pre>
??<b>??</b>????? wa ????????? ???
??- <b>??</b>- ???      =??      ??- ??- ???=??      ???
PST-<b>PFV</b>-be.scared=3PL.ABS PST-PFV-run=3PL.ABS away
'They got scared and ran away'

??????? wa ????????? ???
??- ???      =??      ??- ??- ???=??      ???
PST-be.scared=3PL.ABS PST-PFV-run=3PL.ABS away
'They were scared and ran away'

<b>??</b>????? ???
<b>??</b> -???      =??      ???
<b>PFV</b>-be.hungry=3SG.ABS soon
'It should get hungry soon'

????? ???
???      =??      ???
be.hungry=3SG.ABS soon
'It should be hungry soon'
</pre>

#### <a name="imperfective_aspect"></a>5.6.2. Imperfective aspect <a href="#table_of_contents">^</a>

The imperfective aspect is generally used with dynamic verbs to refer to events that are incomplete, in progress, or otherwise ongoing. It is morphologically unmarked.

<pre>
????? eng ???
<b>∅</b>-   ??- ???  eng    ???
<b>IPFV</b>-MED-cook DEF.SG cassava
'The cassava is cooking'

????? ??? ????? ??? ?????
<b>∅</b>-   ???-??      ???  <b>∅</b>-   ??~   ???   ???     ???  -??
<b>IPFV</b>-see-1SG.ERG COMP <b>IPFV</b>-ANTIP~laugh INDF.PL child-3PL.POSS
'I see some of their children laughing'

????? eng ??? wa ??? ???
<b>∅</b>-   ???-??      eng    ???   wa      ???  ???
<b>IPFV</b>-don-1SG.ERG DEF.SG woman INDF.SG robe beautiful
'The woman is putting on a beautiful robe'
</pre>

For verbs that refer to mental states, such as **\[?\]** 'to know' or **\[?\]** 'to like', the imperfective is used to refer to being in that mental state. Using one of these verbs in the perfective aspect indicates entry into the state.

<pre>
??????? nī ??? ???
<b>∅</b>-   ???   -??     =??      nī     ???  ???
<b>IPFV</b>-please-3PL.ERG=3SG.ABS DEF.PL bird here
'She likes the birds here'

??? ????? eng ?????
??? <b>∅</b>-   ??? -??      eng    ??? =??
Q   <b>IPFV</b>-know-2PL.ERG DEF.SG make=3SG.ABS
'Do you know how to make it?'

??<b>??</b>????? ??? ??????? ???
??- <b>??</b>- ??? -??      ???  ??- ??? =??      ???
PST-<b>PFV</b>-know-1PL.ERG COMP PFV-come=3PL.ABS yesterday
'We learned that they came yesterday'
</pre>

This aspect is also used to refer to events that happen habitually or customarily.

<pre>
????? neng ???
<b>∅</b>-   ??? =??      neng       ???
<b>IPFV</b>-wake=3SG.ABS LOC.DEF.SG dawn
'She wakes up at dawn'

????? neng ???
??? =??      neng       ???
wake=3SG.ABS LOC.DEF.SG dawn
'She will wake up at dawn'
</pre>
...
Nī ??? ???
nī     ???    <b>∅</b>-   ???
DEF.PL jaguar <b>IPFV</b>-roar
'The jaguars roar', or 'Jaguar roar'

??? nī ??? ???
???        nī     ???    <b>∅</b>-   ???
last.month DEF.PL jaguar <b>IPFV</b>-roar
'Last month, the jaguars would roar', or 'Last month, jaguar roar (as a general truth)'
</pre>

#### <a name="iterative_aspect"></a>5.6.3. Iterative aspect <a href="#table_of_contents">^</a>

The iterative aspect is used to denote repetitions of an event over a relatively short time. It might variously be translated into English using phrases such as 'repeatedly' or 'over and over', depending on the semantics of the verb. It is marked by reduplication of the first syllable of the stem, lengthening the vowel if it is short.

<pre>
????<b>??</b>????? ??? ??? ????? ???
??- ??- <b>??</b>~  ???     =??      ??? ??? ??- ??? ???
PST-PFV-<b>ITER</b>~call.out=1SG.ABS but NEG PST-COP response
'I called and called, but there was no response'

??<b>??</b>??? ???
??- <b>??</b>~  ???  =??      ???
PST-<b>ITER</b>~blink=1SG.ABS fast
'She was blinking rapidly'
</pre>

This reduplication pattern can also be used to indicate that the action occurs in multiple locations, or at different places in the same location.

<pre>
????<b>??</b>??????? eng ???
??- ??- <b>??</b>~  ??? -??     =??      eng    ???
PST-PFV-<b>ITER</b>~poke-3RG.ERG=3SG.ABS DEF.SG child
'The child poked it all over'

??<b>??</b>??? ????? no eng ???
??- <b>??</b>~  ???     ???  =??      no  eng    ???
PST-<b>ITER</b>~collect berry=1SG.ABS LOC DEF.SG field
'They would gather berries around the field'
</pre>

#### <a name="durative_iterative_aspect"></a>5.6.4. Durative-iterative aspect <a href="#table_of_contents">^</a>

The durative-iterative aspect is used to denote repetitions of an event that persist for longer than usual. It might be translated into English using phrases such as 'for a while' or 'for a long time'. It is marked by full reduplication of the stem.

<pre>
??<b>??</b>????? eng ??? ???
??- <b>??</b>~  ???   -??      eng    ???   ???
PST-<b>INTS</b>~strike-3RG.ERG DEF.SG metal hot
'He was striking the hot metal for a long time'
</pre>

This reduplication pattern marks the iterative aspect only for telic verbs. Its other function, which is available to both telic and atelic verbs, is to intensify the verb. Whether the verb is to be read as happening multiple times or intensely depends on its telicity as well as context.

<pre>
??<b>??</b>??????? neng ???
??- <b>??</b>~  ???  -??     =??      neng       ???
PST-<b>INTS</b>~throw-3RG.ERG=3PL.ABS LOC.DEF.SG lake
'She was throwing them into the lake for a while', or 'She was hurling them into the lake'
</pre>

Stative verbs can be marked in this way, in which case the verb is always interpreted as happening intensely rather than repeatedly.

<pre>
<b>??</b>?????
<b>??</b>~  ???      =??
<b>INTS</b>~be.afraid=3PL.ABS
'They are very afraid', not *'They are afraid repeatedly'
</pre>

When perfective, the iterative interpretation becomes available.

<pre>
????<b>??</b>????? eng ???
??- ??- <b>??</b>~  ???      =??      eng    ???
PST-PFV-<b>INTS</b>~be.afraid=3PL.ABS DEF.SG night
'They kept getting scared in the night'
</pre>

### <a name="verb_voice"></a>5.7. Voice <a href="#table_of_contents">^</a>

Nga'ō has five morphologically distinct voices: active, mediopassive, antipassive, applicative, and causative. The causative voice can combine with every other voice, but the other voices cannot combine with each other.

#### <a name="active_voice"></a>5.7.1. Active voice <a href="#table_of_contents">^</a>

As in other languages, the active voice is the default voice in Nga'ō, and it is not morphologically marked. The verb's core arguments are all present, and none are treated differently by being made the object of a preposition or similar. Pragmatically, the first overt noun is the most salient referent in the discourse, which in practice generally means that an agent is more salient than a patient is more salient than an oblique, assuming that none are pronominal.

#### <a name="mediopassive_voice"></a>5.7.2. Mediopassive voice <a href="#table_of_contents">^</a>

The mediopassive voice can be applied to transitive verbs to make them intransitive, promoting O to the role of S. It is marked by the prefix **wan-**, with the nasal undergoing normal allophony based on the following consonant or vowel.

<pre>
????????? eng ???
??- ??- ??? -??      eng    ???
PST-PFV-open-3PL.ERG DEF.SG chest
'They opened the chest'
  
????<b>??</b>??? eng ???
??- ??- <b>??</b>- ???  eng    ???
PST-PFV-<b>MED</b>-open DEF.SG chest
'The chest was opened'
</pre>

When used as a passive, the agent cannot be reintroduced in an oblique phrase.

<pre>
* ????<b>??</b>??? eng ??? ??? ???
  ??- ??- <b>??</b>- ???  eng    ???   ??? ???
  PST-PFV-<b>MED</b>-open DEF.SG chest ABL 3PL
  Intended: 'The chest was opened'
</pre>

It can also be used as a middle voice.

<pre>
<b>??</b>??? nī ???
<b>??</b>- ???  nī    ???
<b>MED</b>-cook DEF.PL meat
'The meats are cooking'
  
????<b>??</b>??? eng ???
??- ??- <b>??</b>- ???  ???    eng    ???
PST-PFV-<b>MED</b>-cook slowly DEF.SG door
'The door opened slowly'
</pre>

#### <a name="antipassive_voice"></a>5.7.3. Antipassive voice <a href="#table_of_contents">^</a>

The antipassive voice can be applied to transitive verbs to make them intransitive, promoting A to the role of S and demoting O to an optional oblique phrase. It is marked by reduplication of the first consonant of the stem and the vowel /a/. The reduplicant is generally **Ca-** or **aC-**, where **C** is the first consonant in the base.

Words starting with consonants that can normally be geminated (/m, n, ŋ, p, t k, s/) take the reduplicant **aC-**, as in **annē** from **nē** '\[?\]'. Words starting with /ʔ/ behave the same way, but the resulting geminate surfaces exceptionally as /s.s/ and not */ʔ.ʔ/, as in **assaki** from **'aki** '\[?\]'. Words starting with other consonants take the reduplicant **Ca-**, as in **yayachi** from **yachi** '\[?\]', and words containing no consonants take the **ah-** instead.

The promotion and demotion of arguments can be seen in the examples below. The verbs with antipassive morphemes in the first two examples have no ergative suffix, and the leaves in the last example take the preposition \[?\] or are dropped completely.

<pre>
????? wa ??? nī ???
???-??      wa      ???  nī     ???
eat-3SG.ERG INDF.SG deer DEF.PL leaf
'A deer is eating the leaves'
  
<b>??</b>??? wa <b>???</b> nī ???
<b>??</b>~   ??? wa      ???  <b>???</b> nī     ???
<b>ANTIP</b>~eat INDF.SG deer <b>ABL</b> DEF.PL leaf
'A deer is eating the leaves'
  
<b>??</b>??? wa
<b>??</b>~   ??? wa      ???
<b>ANTIP</b>~eat INDF.SG deer
'A deer is eating (something)'
</pre>

This promotion of A into S using the antipassive voice is mandatory for A to be relativized.

<pre>
????????? nī ??? eng ???
??- ??- ???   -??      nī     ???   eng    ???
PST-PFV-invite-3PL.ERG DEF.PL adult DEF.SG boy
'The adults invited the boy'
  
eng ??? ??????????? nī ???
eng    ??? ??- ??- ???   -??     =??      nī     ???
DEF.SG boy PST-PFV-invite-3PL.ERG=3SG.ABS DEF.PL adult
'the boy that the adults invited'

nī ??? ????<b>??</b>??????? eng ???
nī     ???   ??- ??- <b>??</b>~   ???   -??     =??      eng    ???
DEF.PL adult PST-PFV-<b>ANTIP</b>~invite-3PL.ERG=3SG.ABS DEF.SG boy
'the adults who invited the boy'
</pre>

##### As a verbalizer

The primary function of this marker is the antipassive voice, but it is also used for derivation to turn nouns into intransitive verbs. The verb resulting from this noun generally means 'to make (noun)' or occasionally 'to do (noun)', and it is sometimes idiomatic.

| Nga'ō | English      | Nga'ō      | English                 |
| ----- | ------------ | ---------- | ----------------------- |
| ???   | 'spider web' | **??**-??? | 'to weave a spider web' |
| ???   | 'fire'       | **??**-??? | 'to start a fire'       |
| ???   | 'light'      | **??**-??? | 'to glow'               |
| ???   | 'blood'      | **??**-??? | 'to bleed'              |
| ???   | 'home'       | **??**-??? | 'to start a family'     |

#### <a name="causative_voice"></a>5.7.4. Causative voice <a href="#table_of_contents">^</a>

The causative suffix **-ih** applies only to intransitive verbs, which become transitive. The causee stays as a P argument morphosyntactically, and the causer may be either allowing or forcing the causee to act.

<pre>
??? eng ????? ???
???  eng    ???  -??       ???
grow DEF.SG beard-3SG.POSS thick
'His thick beard is growing'

???<b>??</b>?? wa ??? ???
??? -<b>??</b>  -??      wa      ???   ???
grow-<b>CAUS</b>-3SG.ERG INDF.SG beard thick
'His thick beard is growing'

????????? ??? eng ?????
??- ??- ???=??      ??? eng    ???   -??
PST-PFV-go =1SG.ABS COM DEF.SG sister-1SG.POSS
'I went with my sister'

???????<b>??</b>???? eng ????? ??? ???
??- ??- ???-<b>??</b>  -??     =??      eng    ???   -??       ??? ???
PST-PFV-go -<b>CAUS</b>-3SG.ERG=1SG.ABS DEF.SG sister-1SG.POSS COM 3SG
'My sister let/made me go with her'
</pre>

There is also a periphrastic causative construction, which is necessary for transitives, as well as an unproductive causative morpheme that forms some lexical causatives.

#### <a name="applicative_voice"></a>5.7.5. Applicative voice <a href="#table_of_contents">^</a>

The benefactive preposition **\[?\]** is used for the recipient of verbs such as **\[?\]**, 'to supply', as well as for the beneficiaries of verbs that don't normally have a recipient.

<pre>
????? ??? <b>???</b> eng ?????
??? -??      ???  <b>???</b> eng    ???  -??
make-1SG.ERG this <b>BEN</b> DEF.SG woman-1SG.POSS
'I'm making this for my wife'

??????? ??? ??? ??? ??? <b>???</b> ???
??- ???   -??      ???     ???   ???   ??? <b>???</b> ???
PFV-supply-3PL.ERG INDF.PL spear sharp two <b>BEN</b> 2SG
'They will supply you with two sharp spears'
</pre>

More commonly, instead of using **\[?\]**, the verb takes an applicative postclitic, and the object of **\[?\]** moves to be immediately postverbal. If it was a pronoun, it is instead marked as a P argument on the verb.

<pre>
?????<b>??</b> eng ????? ???
??? -??     =<b>??</b>   eng    ???  -??       ???
make-1SG.ERG=<b>APPL</b> DEF.SG woman-1SG.POSS this
'I'm making this for my wife'

???????<b>??</b><b>??</b> ??? ??? ??? ???
??- ???   -??     =<b>??</b>  =<b>??</b>      ???     ???   ???   ???
PFV-supply-3PL.ERG=<b>APPL</b>=<b>2SG.ABS</b> INDF.PL spear sharp two
'They will supply you with two sharp spears'
</pre>

Going forward, I will use standard terminology and call this object the _applied object_ and the original direct object the _base object_. Morphosyntactically, the applied object completely replaces the base object, which becomes optional and may be dropped. Only the applied object is accessible for various purposes, including:
...
?????????<b>??</b>?? eng ??? eng ???
??- ??- ??? -??     =<b>??</b>  =??      eng    ???   eng    ???
PST-PFV-cook-3SG.ERG=<b>APPL</b>=3SG.ABS DEF.SG child DEF.SG animal
'He cooked the animal for the child'

Eng ??? ?????????<b>??</b>?? eng ???
eng    ???   ??- ??- ??? -??     =<b>??</b>  =??      eng    ???
DEF.SG child PST-PFV-cook-3SG.ERG=<b>APPL</b>=3SG.ABS DEF.SG animal
'the child that he cooked the animal for'

Eng ??? ?????????<b>??</b>?? eng ???
eng    ???    ??- ??- ??? -??     =<b>??</b>  =??      eng    ???
DEF.SG animal PST-PFV-cook-3SG.ERG=<b>APPL</b>=3SG.ABS DEF.SG child
Intended: 'the animal that he cooked for the child'
Actual:   'the animal that he cooked the child for'
</pre>
...
??? eng ??? ?????????<b>??</b> eng ???
??? eng    ???     ??- ??- ??? -??     =<b>??</b>   eng    ???
FOC DEF.SG butcher PST-PFV-cook-3SG.ERG=<b>APPL</b> DEF.SG armadillo
'They carried the armadillo into the room for <b>the butcher</b>'

??? eng ??? ?????????<b>??</b> eng ???
??? eng    ???       ??- ??- ??? -??     =<b>??</b>   eng    ???
FOC DEF.SG armadillo PST-PFV-cook-3SG.ERG=<b>APPL</b> DEF.SG butcher
Intended: 'They carried <b>the armadillo</b> into the room for the butcher'
Actual:   'They carried the butcher into the room for <b>the armadillo</b>'
</pre>

##### Analysis as a clitic

I treat the applicative marker as a clitic rather than a suffix primarily because, like the P clitics, it does not attract stress and can attach to an incorporated noun.

#### <a name="voice_combinations"></a>5.7.6. Voice combinations <a href="#table_of_contents">^</a>

A verb can be marked for marked for any of the above voices individually, and it may also be marked for the causative voice and any other voice. Semantically, the order in which the markers apply is first causative, then mediopassive or antipassive, and then lastly the applicative. In practice, this means that the causative morpheme can still only be used with root intransitive verbs, and it cannot be used for detransitivized verbs.

<pre>
?????????
??- ??- ???  =??
PST-PFV-sleep=1SG.ABS
'I slept'

??? ???????<b>??</b>????
???  ??- ??- ???  -<b>??</b>  -??     =??
this PST-PFV-sleep-<b>CAUS</b>-3SG.ERG=1SG.ABS
'This made/let me sleep'

????<b>??</b>???<b>??</b>??
??- ??- <b>??</b>- ???  -<b>??</b>  =??
PST-PFV-<b>MED</b>-sleep-<b>CAUS</b>=1SG.ABS
'I was made/allowed to sleep'

??? ????<b>??</b>???<b>??</b>
???  ??- ??- <b>??</b>~   ???  -<b>??</b>
this PST-PFV-<b>ANTIP</b>~sleep-<b>CAUS</b>
'This put (something) to sleep'
...
???????<b>??</b>??
??- ??? -??     =<b>??</b>  =??
PFV-wake-3SG.ERG=<b>APPL</b>=3PL.ABS
'He will wake up for them'

?????<b>??</b>??<b>??</b>?? nī ???
??- ??? -<b>??</b>  -??     =<b>??</b>  =??      nī     ???
PFV-wake-<b>CAUS</b>-3SG.ERG=<b>APPL</b>=3PL.ABS DEF.PL child
'He will wake up the children for them'
</pre>

Because the voices cannot generally freely combine, periphrasis must be used to convey meanings such as in _The room was lit up for me_.

<pre>
??????????? eng ??? ??? ???
??- ??- ??- ???     -??   eng    ???  ??? ???
PST-PFV-MED-be.light-CAUS DEF.SG room BEN 1SG
'The room was lit up for me'

??????????? ??? ??? ??????? eng ???
??- ??- ??- ???=??      ??? ???  ??- ??-???      eng    ???
PST-PFV-MED-do =3SG.ABS BEN 1SG PST-PFV-be.light DEF.SG room
'The room was lit up for me'
</pre>

### <a name="verb_desiderative"></a>5.8. Desiderative <a href="#table_of_contents">^</a>

The leftmost marker on the verb is the desiderative mood clitic **[?]-**. This corresponds directly to 'want' in English when the subject or agent of the verb wants the action. For the rest of this section, I will refer to the one wanting the action as the 'wanter'.

<pre>
<b>??</b>???????
<b>??</b>-   ???- ??-    =??
<b>DESID</b>-help-1SG.ERG=2SG.ABS
'I want to help you'
  
??? <b>??</b>????? ??? ???
??? <b>??</b>-   ???=??      ??? ???
NEG <b>DESID</b>-go =1PL.ABS COM 3PL
'We don't want to go with them'
  
<b>??</b>???????
<b>??</b>-   ??- ???=??
<b>DESID</b>-PST-go =1SG.ABS
'I wanted to sleep'
  
<!-- <b>??</b>????? eng ????? nī ??? ???
<b>??</b>-   ???-??      eng    ???   -??       nī     ???     ???
<b>DESID</b>-buy-3SG.ERG DEF.SG friend-1SG.POSS DEF.PL garment this.PL
'My friend wants to buy these clothes'
  
nī ??? ??? <b>??</b>???????
nī     ???     ???     <b>??</b>-   ???-??     =??
DEF.PL garment this.PL <b>DESID</b>-buy-1SG.ERG=3SG.ABS
'these clothes I want to buy' -->
</pre>

Notice that above, the verbs are all in the imperfective aspect. In fact, the addition of **\[?\]-** causes a verb to become stative if it was not already stative. Like other stative verbs, using them in the perfective aspect makes them dynamic and indicates entry into the verbs' states.

<pre>
??<b>??</b>???????
??-   <b>??</b>- ???- ??-    =??
DESID-<b>PFV</b>-help-1SG.ERG=2SG.ABS
'I will want to help you'
  
??? ??<b>??</b>????? ??? ???
??? ??-   <b>??</b>  ???=??      ??? ???
NEG DESID-<b>PFV-</b>go =1PL.ABS COM 3PL
'We don't want to go with them anymore'

????<b>??</b>???????
??-   ??- <b>??</b>- ???- ??-    =??
DESID-PST-<b>PFV</b>-help-1SG.ERG=2SG.ABS
'I wanted to sleep (I didn't before)', or 'Now I want to sleep'
</pre>

As can be seen in the last example, this is less straightforward in the past perfective. This can be used literally to describe starting to want something in the past and is common in narratives like below.

<pre>
??? ??? ??????????? ????????? eng ??? ???
??? ???  ??-   ??- ??- ???  =??      ??- ??- ???  -??      eng    ???     ???
and when DESID-PST-PFV-sleep=1SG.ABS PST-PFV-start-1SG.ERG DEF.SG collect tree
'And when I wanted to sleep, I started collecting some wood'
</pre>

In practice, the past perfective is semantically more like an implied perfect; it is used when the speaker has just learned information that makes them start or stop wanting the action. This can be seen in the short dialogue below.

<pre>
??? ?????? eng ??? ???????????
??? ???~ ???          eng    ???    ??- ??- ??? -??     =??
COP INTS~be.delicious DEF.SG (food) PST-PFV-cook-3PL.ERG=3SG.ABS
'The [?] they made is really good!'
  
??? ??<b>??</b><b>??</b>???????
??? ??-   <b>??</b>- <b>??</b>- ??~   ???=??
??? DESID-<b>PST</b>-<b>PFV</b>-ANTIP~eat=1SG.ABS
'Oh, now I want some!'
</pre>

#### <a name="other_desires"></a>5.8.1. Other expressions of desire <a href="#table_of_contents">^</a>

In all of the examples in the previous section, the subject or agent of the action is also the wanter, and it was always in first person. When either of these cases doesn't hold, the construction is somewhat different.

When the subject or agent of the action is the wanter and is first person, the speaker is communicating something about their own desires, of which they have direct information. However, the speaker cannot know the internal state of others directly, and instead relies on others communicating their desires or otherwise displaying signs about them. So, when the subject or agent is also the wanter but not first person, the speaker generally must use the inferential evidential particle **\[?\]** (described in more detail in \[?\]).

<pre>
<b>???</b> ??????? ???
<b>???</b>   ??-   ???-??      ???
<b>INFER</b> DESID-say-2SG.ERG what
'You seem like you want to say something'

<b>???</b> ??????? no ??? ???
<b>???</b>   ??-   ???   =??      no  ???     ???
<b>INFER</b> DESID-return=3SG.ABS LOC INDF.PL water
'It looks like it wants to go back in water'
</pre>

When the subject or agent of the verb is not the same as the wanter, the verbal adjective **\[?\]** 'to be wanted' is used instead of the desiderative prefix. Normally, the subject of this adjective is the thing wanted, and the object of the preposition **no** '\[?\]' is the wanter, usually placed after the adjective.

<pre>
??? <b>no</b> ??? ???
???       <b>no</b>  ??? ???
be.wanted <b>LOC</b> 1SG this
'I want this'

????? <b>no</b> ??? wa ?????
??- ???       <b>no</b>  ??? wa      ??? -??
PST-be.wanted <b>LOC</b> 1PL INDF.SG food-3PL.POSS
'We wanted some of their food'
</pre>

Like before, a non-first person wanter requires the use of the inferential particle.

<pre>
??? <b>???</b> ????? no ???
??? <b>???</b>   ???      =??      no  ???
NEG <b>INFER</b> be.wanted=3SG.ABS LOC 2SG
'You don't sound like you want it'

<b>???</b> ??? no ??? wa ?????
<b>???</b>   ???       no  ??? wa      ??? -??
<b>INFER</b> be.wanted LOC 3PL INDF.SG hand-3SG.POSS
'They want her help'
</pre>

When the thing wanted is an action, the action must be complementized. The expression is otherwise the same as above.

<pre>
??? ??? no ??? <b>???</b> ????? ???
??? ???       no  ??? <b>???</b>  ??? =??      ???
NEG be.wanted LOC 1SG <b>COMP</b> stay=3PL.ABS here
'I don't want them to stay here'

??? ????? no ??? <b>???</b> ?????????
??? ??- ???       no  ??? <b>???</b>  ??- ???-??     =??
Q   PST-be.wanted LOC 2SG <b>COMP</b> PST-say-1SG.ERG=3SG.ABS
'Did you want me to say it?'

??? ?????????? no ??? <b>???</b>  ???????
???   ??- ??- ???~ ???       no  ??? <b>???</b>  ??? -??     =??
INFER PST-PFV-INTS~be.wanted LOC 3SG <b>COMP</b> kill-3SG.ERG=3SG.ABS
'She really looks like she wants to kill him now'

??? ??? no ??? <b>???</b> ??????? ??? ???
???   ???       no  ??? <b>???</b>  ??~   ??? =??      ??? ???
INFER be.wanted LOC 3PL <b>COMP</b> ANTIP~give=1SG.ABS BEN 3PL
'They want me to give (it) to them'
</pre>

### <a name="verb_abilitative"></a>5.9. Abilitative <a href="#table_of_contents">^</a>

The abilitative mood is much like the desiderative; it makes the verb become stative unless put in the perfective aspect, which causes it to indicate entry into that state.

<pre>
??? <b>??</b>????? ???
??? <b>??</b>-  ??? -??      ???
Q   <b>ABIL</b>-read-3SG.ERG this
'Can you read this?'
  
??? ??? <b>??</b>?????????
???  ??? <b>??</b>-  ??- ???  -??     =??
then FUT <b>ABIL</b>-PFV-carry-1PL.ERG=3PL.ABS
'Then we will be able to carry them'
</pre>

### <a name="verb_attenuative"></a>5.10. Attenuative <a href="#table_of_contents">^</a>

A particular reduplication pattern applied to verbs marks the attenuative, indicating that the action of the verb is performed less intensely or with less force than is normal. The last two moras of the base are repeated to the right of it, and the initial consonant of the reduplicant is replaced by **w-**, including when it has no consonant at all. If the initial consonant would already be **w-**, or the following vowel is /u/ or /o/, the initial consonant is replaced by **p-** instead.

| Nga'ō                 | English | Nga'ō           | English |
| --------------------- | ------- | --------------- | ------- |
| (placeholder) pase    | '\[?\]' | pase**wase**    | '\[?\]' |
| (placeholder) setā    | '\[?\]' | setā**wā**      | '\[?\]' |
| (placeholder) makira  | '\[?\]' | makira**wira**  | '\[?\]' |
| (placeholder) nochīru | '\[?\]' | nochīru**wiru** | '\[?\]' |
...
?????<b>??</b>ki ???
??~ ???  ~<b>??</b> =ki      only
VBZ~blood~<b>ATT</b>=3SG.ABS only
'He's only kind of bleeding?'
  
?????<b>??</b> eng ???
??- ???  ~<b>??</b>  eng    ???
PST-cough~<b>ATT</b> DEF.SG woman
'The woman was coughing softly'
  
??? ???????<b>??</b>???? ??? ???????????
??? ??- ??- ??? ~<b>??</b> -??     =??      ??? ??- ??- ??? -??     =??
Q   PST-PFV-kick~<b>ATT</b>-2SG.ERG=3SG.ABS Q   PST-PFV-kick-2SG.ERG=3SG.ABS
'Did you lightly kick it or did you kick it?'
</pre>

With adjectives, this derivation indicates that the property is less intense than is normal.

<pre>
Eng ??? ??? neng ??? ??? ??? ???<b>??</b>
eng    ???   ???  neng       ???    ???  ??? ???   ~<b>??</b>
DEF.SG juice lime LOC.DEF.SG bottle this COP yellow~<b>ATT</b>
'The lime juice in this bottle is yellowish'
  
???</b>??</b>?? ??? ?????????
???      ~<b>??</b> =??      ??? ??-  ??~   ??? =??
be.hungry~<b>ATT</b>=1SG.ABS but ABIL-ANTIP~wait=1SG.ABS
...
As mentioned earlier, when used predicatively, verbal adjectives are effectively identical to stative verbs, but nominal adjectives do not take articles while nouns do.
...
When acting attributively, adjectives do not take any additional markers, but they can be negated and intensified using the same morphology as verbs.
