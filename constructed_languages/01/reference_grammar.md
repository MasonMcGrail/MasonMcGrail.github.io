...
??<b>??</b>????? wa ??<b>??</b>????? ???
??- <b>??</b>- ???      =??      ??- <b>??</b>- ???=??      ???
PST-<b>PFV</b>-be.scared=3PL.ABS PST-<b>PFV</b>-run=3PL.ABS away
...
??????? eng ????? ???
??- <b>∅</b>-   ???          =??      eng    ???-??       ???
PST-<b>IPFV</b>-carry.on.back=2SG.ABS DEF.SG boy-2SG.POSS often
'You used to carry your son on your back often'
</pre>
...
'They are very afraid', or *'They are afraid repeatedly'
</pre>
...
The causative suffix \textbf{-ih} applies only to intransitive verbs, which become transitive. The causee stays as a P argument morphosyntactically, and the causer may be either allowing or forcing the causee to act.
...
???????<b>??</b>???? ??? eng ?????
??- ??- ???-<b>??</b>  -??     =??      ??? eng    ???   -??
PST-PFV-go -<b>CAUS</b>-3SG.ERG=1SG.ABS COM DEF.SG sister-1SG.POSS
...
?????????<b>??</b>?? ???
??- ??- ??? -??     =<b>??</b>  =??      ???
PST-PFV-kill-3SG.ERG=<b>APPL</b>=2SG.ABS 3PL
...
The leftmost marker on the verb is the desiderative mood clitic \textbf{[?]-}. This corresponds directly to 'want' in English when the subject or agent of the verb wants the action. For the rest of this section, I will refer to the one wanting the action as the 'wanter'.
...
??? ??????? ???
???   ??-   ???-??      ???
INFER DESID-say-2SG.ERG what
'You seem like you want to say something'

??? ??????? no ??? ???
???   ??-   ???   =??      no  ???     ???
INFER DESID-return=3SG.ABS LOC INDF.PL water
'It looks like it wants to go back in water'
</pre>

When the subject or agent of the verb is not the same as the wanter, the verbal adjective **\[?\]** 'to be wanted' is used instead of the desiderative prefix. Normally, the subject of this adjective is the thing wanted, and the object of the preposition **\[?\]** '\[?\]' is the wanter, usually placed after the adjective.

<pre>
??? no ??? ???
???       no  ??? ???
be.wanted LOC 1SG this
'I want this'

????? no ??? wa ?????
??- ???       no  ??? wa      ??? -??
PST-be.wanted LOC 1PL INDF.SG food-3PL.POSS
...
??? ??? ????? no ???
??? ???   ???      =??      no  ???
NEG INFER be.wanted=3SG.ABS LOC 2SG
'You don't sound like you want it'

??? ??? no ??? wa ?????
???   ???       no  ??? wa      ??? -??
INFER be.wanted LOC 3PL INDF.SG hand-3SG.POSS
'They want her help'
</pre>
...
??? ??? no ??? ??? ????? ???
??? ???       no  ??? ???  ??? =??      ???
NEG be.wanted LOC 1SG COMP stay=3PL.ABS here
'I don't want them to stay here'

??? ????? no ??? ??? ?????????
??? ??- ???       no  ??? ???  ??- ???-??     =??
Q   PST-be.wanted LOC 2SG COMP PST-say-1SG.ERG=3SG.ABS
'Did you want me to say it?'

??? ?????????? no ??? ???  ???????
???   ??- ??- ???~ ???       no  ??? ???  ??? -??     =??
INFER PST-PFV-INTS~be.wanted LOC 3SG COMP kill-3SG.ERG=3SG.ABS
'She really looks like she wants to kill him now'

??? ??? no ??? ??? ??????? ??? ???
???   ???       no  ??? ???  ??~   ??? =??      ??? ???
INFER be.wanted LOC 3PL COMP ANTIP~give=1SG.ABS BEN 3PL
...
??? ??????? ???
??? ??-  ??? -??      ???
Q   ABIL-read-3SG.ERG this
'Can you read this?'
  
??? ??? ???????????
???  ??? ??-  ??- ???  -??     =??
then FUT ABIL-PFV-carry-1PL.ERG=3PL.ABS
